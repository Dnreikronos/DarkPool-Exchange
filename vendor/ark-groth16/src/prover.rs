...
use crate::r1cs_to_qap::ConstraintMatrices;
...
impl<E: Pairing, QAP: R1CSToQAP> Groth16<E, QAP> {
        ...
        QAP: R1CSToQAP,
    {
        ...
        let prover_ref = cs.borrow().unwrap();
        let instance_assignment = prover_ref
            .instance_assignment()
            .map_err(|_| ark_relations::gr1cs::SynthesisError::AssignmentMissing)?;
        let witness_assignment = prover_ref
            .witness_assignment()
            .map_err(|_| ark_relations::gr1cs::SynthesisError::AssignmentMissing)?;
