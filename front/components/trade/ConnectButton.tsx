...
export function ConnectButton() {
  ...
  return (
    <>
      ...
      {pickerOpen && (
        <PickerModal onPick={handlePick} onClose={() => setPickerOpen(false)} />
      )}
    </>
  )
}
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm border border-brand-border bg-brand-surface p-8"
      >
        <h2
          id={titleId}
          className="mb-6 font-mono text-label-md uppercase text-brand-muted"
        >
          CONNECT WALLET
        </h2>
